# Driving License Renewal Assistance System
This project focuses on a dialog system developed to facilitate the process of renewing driving licenses across all categories. The system has been implemented as a case study, adhering to the structure and guidelines provided for public service dialog systems.

You can visit the web-based dialogue system that the template belongs to [here](https://govgr-mobility-card.github.io/info-for-mobility-card-gr/).
