$("document").ready(function () {
  ...
  function skipToEnd(message) {
    ...
    const error =
      currentLanguage === "greek"
        ? "Λυπούμαστε αλλά δεν δικαιούστε ανανέωση της άδειας οδήγησης!"
        : "We are sorry but you are not entitled to renew your driver's license!";
  ...
  function retrieveAnswers() {
    ...
    if(allAnswers[6] === "2" || allAnswers[6] === "3"){
      getEvidencesById(11);
    }
    if(allAnswers[6] === "4"){
      getEvidencesById(12);
  ...
  function submitForm() {
    ...
    currentLanguage === "greek"
      ? $(".question-container").append(
          "<br /><br /><h5 class='answer'>Τα δικαιολογητικά που πρέπει να προσκομίσετε για την ανανέωση της άδειας οδήγησης είναι τα εξής:</h5><br />"
        )
      : $(".question-container").append(
          "<br /><br /><h5 class='answer'>The documents you need to provide for the renewal of the driver's license are the following:</h5><br />"
        );
  ...
  $("#nextQuestion").click(function () {
    if ($(".govgr-radios__input").is(":checked")) {
      ...
      if (currentQuestion === 0 && selectedRadioButtonIndex === 2) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Χρειάζεται να έχετε ήδη ισχύουσα άδεια οδήγησης! Προχωρήστε στην διαδικασία έκδοσης!") : skipToEnd("You must already have a valid driver's license! Proceed with the issuance process!");
      } else if (currentQuestion === 1 && selectedRadioButtonIndex === 3) {
        currentQuestion = -1;
        currentLanguage === "greek" ? skipToEnd("Πρέπει να έχετε συμπληρώσει το δέκατο όγδοο (18) έτος!") : skipToEnd("You must have reached the eighteenth (18th) year of age!");
      } else {
